...
#     --image-folder SpatialBot/eval/mme/MME_Benchmark_release_version/MME_Benchmark \
...
python calculation_mme.py --results_dir SpatialBot/eval/mme/answers_upload/$TARGET_DIR \
